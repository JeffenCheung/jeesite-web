	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#contentTable tbody tr").on("dblclick", function() {
			    location.href="${ctx}/sys/role/form?id="+this.id;
			});
		});
	</script>
</head>
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover table-fixed-header">
		<thead class="header"><tr><th>角色名称</th><th>英文名称</th><th>归属机构</th><th>数据范围</th><shiro:hasPermission name="sys:role:edit"><th>操作</th></shiro:hasPermission></tr></thead>
