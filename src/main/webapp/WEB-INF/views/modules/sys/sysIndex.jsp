		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/index-${fns:getCurrentSiteId()}.html" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
					<li id="themeSwitch" class="dropdown" style="display:${fns:getConfigBoolean('hideThemeSwitch') ? 'none' : ''};">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="javascript:cookie('breadcrumbmode','${breadcrumbmode eq '1' ? '0' : '1'}');location=location.href">${breadcrumbmode eq '1' ? '关闭' : '开启'}导航模式</a></li>
						</ul>
